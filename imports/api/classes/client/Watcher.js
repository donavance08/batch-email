...
export default class Watcher {
	...
	constructor(parent) {
		...
		this.#user = this.#parent ? this.#parent.user : () => console.log('No active parent found');
		// this.#login = this.#parent ? this.#parent.user : () => console.log('No active parent found');
		this.#logout = this.#parent ? this.#parent.logout : () => console.log('No active parent found');
		this.#callFunction = this.#parent
			? this.#parent.callFunction
			: () => console.log('No active parent found');
		this.#callSubscribe = this.#parent
			? this.#parent.callSubscribe
			: () => {
					console.log('No active parent found');
			  };
	}
	...
	get NativeSubscribe() {
		...
		return this.#parent.#callSubscribe;
	}
	get NativeCall() {
	...
	login(selector, password, callback) {
		return this.#parent.login(selector, password, callback);
	}
